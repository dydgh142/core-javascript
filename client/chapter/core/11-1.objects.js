...
// const getPropertiesListobject = object => Object.keys(object);

function getPropertiesList(object) {
  let result = [];
  for (let key in object) {
    if ({}.hasOwnProperty.call(object, key)) result.push(key);
  }
  return result;
}
console.log(result);

// @@@@@@@@@@@@@@@@ 프로퍼티 제거remove  or 삭제 delete
// @@@ 함수만드는방법
//1. 함수 이름 정하기
...
//or
//const student ={name, email, authoriaction, isLogin}
