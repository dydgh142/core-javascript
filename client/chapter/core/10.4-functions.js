...
//빈 객체 생성 (그저 이름만 cache일뿐)
memoFibo.cache = {};

//memoFibo 에 작은 주머니를 하나 만듬 cache 라는.
// 거기에 계산된 값들을 계속 더해서 저장해둠.
// 나중에 필요할때 추가로 가져와서 사용.
// if(memoFibo.cache[n]) 계산된게 있으면 바로 사용.
// memoFibo.cache[n] = memoFibo(n - 1) + memoFibo(n - 2) 계산된거 memoFibo.cache에 저장
// cache는 내가 임의로 만든 이름
